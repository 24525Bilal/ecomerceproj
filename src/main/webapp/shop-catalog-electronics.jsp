                            ...
                            <div class="col">
                                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                                    <div class="position-relative">
                                        ...
                                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="shop-product-electronics.html?id=${product.id}">
...
<%--                                                     <img src="${pageContext.request.contextPath}/${product.thumbnailUrl}" alt="${product.name}">--%>
                                    ...
                                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                                        ...
                                        <h3 class="pb-1 mb-2">
                                            <a class="d-block fs-sm fw-medium text-truncate" href="shop-product-electronics.html?id=${product.id}">
