...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>BuyHive | Account - Personal Info</title>
                ...
                <div class="ps-lg-3 ps-xl-0">
                    ...
                    <div class="border-bottom py-4">
                        ...
                        <div class="collapse basic-info" id="basicInfoEdit">
                            <form method="post" action="UpdateUserDetailsServlet" class="row g-3 g-sm-4 needs-validation" novalidate="">
                                <div class="col-sm-6">
                    ...
                    <div class="border-bottom py-4">
                        <div class="nav flex-nowrap align-items-center justify-content-between pb-1 mb-3">
                            ...
                            <a class="nav-link hiding-collapse-toggle text-decoration-underline p-0 collapsed" href=".contact-info" data-bs-toggle="collapse" aria-expanded="false" aria-controls="contactInfoPreview contactInfoEdit">Edit</a>
                        </div>
                        ...
                        <div class="collapse contact-info" id="contactInfoEdit">
                            <form method="post" action="UpdateContactServlet" class="row g-3 g-sm-4 needs-validation" novalidate="">
                                <div class="col-sm-6">
                    ...
                    <div class="border-bottom py-4">
                        ...
                        <div class="collapse password-change" id="passChangeEdit">
                            ...
                            <form method="post" action="UpdatePasswordServlet" class="row g-3 g-sm-4 needs-validation" novalidate="">
                                <div class="col-sm-6">
                                    <label for="current-password" class="form-label">Current password</label>
                                    <div class="password-toggle">
                                        <input type="password" class="form-control" id="current-password" name="current-password" placeholder="Enter your current password" required="">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="password-toggle">
                                        <input type="password" class="form-control" id="new-password" name="new-password" placeholder="Create new password" required="">
                                        <label class="password-toggle-button" aria-label="Show/hide password">
                                            <input type="checkbox" class="btn-check">
                                        </label>
                                    </div>
                    ...
                    <div class="pt-3 mt-2 mt-sm-3">
                        ...
                        <form method="post" action="DeleteAccountServlet" onsubmit="return confirm('Are you sure you want to delete your account? This action cannot be undone.')">
                            <button type="submit" class="text-danger fs-sm fw-medium btn btn-link p-0">Delete account</button>
                        </form>
                    </div>
