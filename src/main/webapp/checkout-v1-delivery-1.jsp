                                ...
                                <div class="ms-n5 ms-sm-0">
                                    ...
                                    <div class="d-flex flex-column flex-md-row align-items-md-end gap-3 gap-xl-4">
                                        <div class="w-100">
                                            ...
                                            <input type="text" class="form-control form-control-lg" id="postcode" placeholder="e.g. H1 1AG" value="${primaryAddress != null ? primaryAddress.zipCode : ''}">
                                        </div>
                                        <a class="btn btn-lg btn-primary" href="checkout-v1-delivery-2.jsp">
