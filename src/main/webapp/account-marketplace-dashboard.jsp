                ...
                <div class="offcanvas-body pt-3 pb-4 py-lg-0 mx-lg-auto">
                    <ul class="navbar-nav position-relative">
                        <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link" href="home-electronics.jsp">Home</a>                        
                        </li>
                        <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link" href="shop-catalog-electronics.jsp">Shop</a>                        
                        </li>
                        <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link" href="shop-catalog-electronics.jsp">Account</a>                        
                        </li>
                        <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                            <a class="nav-link" href="shop-catalog-electronics.jsp">Pages</a>                        
                        </li>
...
<a class="btn btn-icon hover-effect-scale position-relative border rounded-circle overflow-hidden" 
   href="#" 
   role="button" 
  ...
  <span class="d-none d-sm-flex flex-shrink-0 text-primary me-2 position-absolute top-0 start-0 w-100 h-100 justify-content-center align-items-center">
...
<div class="ratio ratio-1x1 border rounded-circle overflow-hidden d-none d-lg-flex justify-content-center align-items-center bg-dark text-primary" style="width: 86px;">
<svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
  ...
  <defs>
    <path id="czlogo" d="M18.689 28.654a1.94 1.94 0 0 1-1.936 1.935 1.94 1.94 0 0 1-1.936-1.935 1.94 1.94 0 0 1 1.936-1.935 1.94 1.94 0 0 1 1.936 1.935z"></path>
                                ...
                                <div class="w-100 ps-2 ms-1 ms-lg-0 ps-lg-0">
                                    <h4 class="h6 mb-1 mb-lg-2">BuyHive</h4>
                    ...
                    Log out
                        ...
                        <div class="offcanvas-header d-lg-block p-lg-0">
                            <button type="button" class="btn btn-dark rounded-pill w-100 animate-scale mt-lg-4">
