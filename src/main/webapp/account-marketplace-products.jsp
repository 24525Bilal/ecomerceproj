...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>BuyHive | Marketplace Account - Products</title>
...
<header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top z-fixed px-0" data-sticky-element="">
    <div class="container flex-nowrap">
        ...
        <!-- Navbar brand (Logo) -->
        <a class="navbar-brand py-1 py-md-2 py-xl-1" href="home-electronics.jsp">
                    ...
                    <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                        ...
                        <ul class="dropdown-menu" style="--cz-dropdown-spacer: .875rem">
                            <li class="hover-effect-opacity px-2 mx-n2">
                                <a class="dropdown-item d-block mb-0" href="home-electronics.jsp">
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-4">
                                ...
                                <div style="min-width: 190px">
                                    ...
                                    <ul class="nav flex-column gap-2 mt-0">
                                        ...
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="checkout-v1-delivery-1.jsp">Delivery Info (Step 1)</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-none d-md-block mx-1">
                ...
                <ul class="dropdown-menu dropdown-menu-end" style="--cz-dropdown-spacer: .625rem">
                    ...
                    <li>
                        <a class="dropdown-item" href="account-marketplace-purchases.html">
                            <i class="ci-shopping-bag fs-base opacity-75 me-2"></i>
                            Purchases (6)
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="account-marketplace-favorites.html">
                            <i class="ci-heart fs-base opacity-75 me-2"></i>
                            Favorites
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="account-marketplace-settings.html">
            ...
            <aside class="col-lg-3">
                ...
                <div class="offcanvas-lg offcanvas-start sticky-lg-top pe-lg-0 pe-xl-4" id="accountSidebar">
                    ...
                    <div class="offcanvas-header align-items-start d-lg-block py-3 p-lg-0">
                        <div class="d-flex align-items-start flex-lg-column gap-lg-3">
                            ...
                            <div class="w-100 ps-2 ms-1 ms-lg-0 ps-lg-0">
                                <h4 class="h6 mb-1 mb-lg-2">Createx Studio</h4>
                    ...
                    <div class="offcanvas-body d-block pt-2 pt-lg-4 pb-lg-0">
                        ...
                        <nav class="list-group list-group-borderless">
                            <a class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" href="account-marketplace-purchases.html">
                                <i class="ci-shopping-bag fs-base opacity-75 me-2"></i>
                                Purchases (6)
                            </a>
                            <a class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" href="account-marketplace-favorites.html">
                                <i class="ci-heart fs-base opacity-75 me-2"></i>
                                Favorites
                            </a>
                            <a class="list-group-item list-group-item-action d-flex align-items-center rounded-pill" href="account-marketplace-settings.html">
                                <i class="ci-settings fs-base opacity-75 me-2"></i>
                                Settings
                            </a>
                    ...
                    <div class="offcanvas-header d-lg-block p-lg-0">
                        <button type="button" class="btn btn-dark rounded-pill w-100 animate-scale mt-lg-4" data-bs-toggle="modal" data-bs-target="#addProductModal">
                    ...
                    <table class="table align-middle fs-sm mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-end d-none d-sm-table-cell" scope="col">
                                <span class="fw-normal text-body">Stock</span>
                            </th>
                            <th class="text-end ps-0 ps-sm-3 pe-0" scope="col">
                        ...
                        <div class="row">
                            <div class="accordion-item col-sm-4 border-0">
                                ...
                                <div class="accordion-collapse collapse d-sm-block" id="categoriesLinks" aria-labelledby="categoriesHeading" data-bs-parent="#footerLinks">
                                    <ul class="nav flex-column gap-2 pt-sm-3 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Vectors</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Photos</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">3D illustrations</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">AI images</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Templates</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Mockups</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="accordion-item col-sm-4 border-0">
                                ...
                                <div class="accordion-collapse collapse d-sm-block" id="membersLinks" aria-labelledby="membersHeading" data-bs-parent="#footerLinks">
                                    <ul class="nav flex-column gap-2 pt-sm-3 pb-3 pb-sm-0 mt-n1 mb-1 mb-sm-0">
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Licenses</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Return policy</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Payment methods</a>
                                        </li>
                                        <li class="d-flex w-100 pt-1">
                                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="#!">Become a vendor</a>
                                        </li>
                                    </ul>
                                </div>
                                <hr class="d-sm-none my-0">
            ...
            <div class="modal-body">
                ...
                <form action="addProduct" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="productDescription" name="productDescription" rows="4" placeholder="Enter a detailed product description"></textarea>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="stockQuantity" class="form-label fw-medium">Stock Quantity</label>
                            <input type="number" class="form-control" id="stockQuantity" name="stockQuantity" placeholder="e.g., 50" required>
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="tags" class="form-label fw-medium">Tags</label>
                        <input type="text" class="form-control" id="tags" name="tags" placeholder="Comma-separated, e.g., apple, phone, m2">
                    </div>

                    <div class="mb-3">
                        <label for="productImage" class="form-label fw-medium">Product Images</label>
                        <input class="form-control" type="file" id="productImage" name="productImage" multiple required>
                        <small class="text-muted">You can upload multiple images.</small>
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-medium">Color Variants</label>
                        <input type="text" class="form-control" name="color" placeholder="e.g. Black, White, Blue">
                    </div>

                    <div class="mb-4">
                        <label class="form-label fw-medium">Size Variants</label>
                        <input type="text" class="form-control" name="size" placeholder="e.g. 64GB, 128GB, 256GB">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="model" placeholder="e.g. iPhone 14 Plus">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Manufacturer</label>
                            <input type="text" class="form-control" name="manufacturer" placeholder="e.g. Apple Inc.">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Finish</label>
                            <input type="text" class="form-control" name="finish" placeholder="e.g. Ceramic, Glass, Aluminium">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Capacity</label>
                            <input type="text" class="form-control" name="capacity" placeholder="e.g. 128GB">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Chip</label>
                            <input type="text" class="form-control" name="chip" placeholder="e.g. A15 Bionic chip">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="diagonal" placeholder="e.g. 6.1&quot;">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Screen Type</label>
                            <input type="text" class="form-control" name="screenType" placeholder="e.g. Super Retina XDR">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Resolution</label>
                            <input type="text" class="form-control" name="resolution" placeholder="e.g. 2778×1284px at 458ppi">
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">Refresh Rate</label>
                            <input type="text" class="form-control" name="refreshRate" placeholder="e.g. 120Hz">
                        </div>
                    </div>
