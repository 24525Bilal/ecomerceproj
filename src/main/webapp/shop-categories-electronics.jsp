...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>BuyHive | Electronics Store - Categories</title>
  ...
  <div class="dropdown-menu rounded-4 p-4">
    ...
    <main class="content-wrapper">
        ...
        <nav class="container pt-3 my-3 my-md-4" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home-electronics.jsp">Home</a></li>
        ...
        <section class="container mb-4">
            <div class="overflow-auto" data-simplebar="" data-simplebar-auto-hide="false">
                <div class="row row-cols-6 g-0" style="min-width: 960px">
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="shop-catalog-electronics.jsp">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 gy-5">
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="shop-catalog-electronics.jsp">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Smartphones</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            ...
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Samsung</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Xiaomi</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Nokia</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Meizu</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Accessories</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Accessory Kits</a>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Tablets</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Apple iPad</a>
                            ...
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Lenovo</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Wearable Electronics</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Smart Watches</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Fitness Trackers</a>
                            </li>
                            ...
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">E-books</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Clips, Arm &amp; Wristbands</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Voice Recorders</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Computers &amp; Laptops</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Asus</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Acer</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">HP (Hewlett Packard)</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Lenovo</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Apple MacBook</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Cameras, Photo &amp; Video</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Photo Cameras</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Video Cameras</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Action Cameras</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Camcorders</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Studio Equipment</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Tripods</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Bags and Covers</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Headphones</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Apple</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Defunc</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">HyperX</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">JBL</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Logitech</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Panasonic</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="hover-effect-scale">
                        ...
                        <h2 class="h6 d-flex w-100 pb-2 mb-1">
                            <a class="animate-underline animate-target d-inline text-truncate" href="shop-catalog-electronics.jsp">Video Games</a>
                        </h2>
                        <ul class="nav flex-column gap-2 mt-n1">
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">PlayStation 5</a>
                            ...
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">PlayStation Controllers</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">PlayStation Games</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Gaming PCs</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Nintendo Switch</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Xbox Series X/S</a>
                            </li>
                            <li class="d-flex w-100 pt-1">
                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0" href="shop-catalog-electronics.jsp">Gaming Peripherals</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row g-3 g-lg-4">
                <div class="col-md-7">
                    <div class="position-relative d-flex flex-column flex-sm-row align-items-center h-100 rounded-5 overflow-hidden px-5 px-sm-0 pe-sm-4">
                        ...
                        <div class="position-relative z-1 text-center text-sm-start pt-4 pt-sm-0 ps-xl-4 mt-2 mt-sm-0 order-sm-2">
                            ...
                            <a class="btn btn-primary" href="shop-product-electronics.jsp">
                  From $899
                ...
                <div class="col-md-5">
                    <div class="position-relative d-flex flex-column align-items-center justify-content-between h-100 rounded-5 overflow-hidden pt-3">
                        ...
                        <a class="position-relative z-1 d-block w-100" href="shop-product-electronics.jsp">
