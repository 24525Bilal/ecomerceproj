    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="reviewDetails" tabindex="-1" aria-labelledby="reviewDetailsLabel" style="width: 500px">
        ...
        <div class="offcanvas-body pt-2">
            ...
            <img src="assets/img/shop/electronics/thumbs/07.png" width="110" alt="MacBook">
                ...
                <div class="w-100 min-w-0 ps-2 ps-sm-3">
                    <h5 class="d-flex animate-underline mb-2">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target" href="shop-product-electronics.jsp">Laptop Apple MacBook Pro 13 M2</a>
                    </h5>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content needs-validation" novalidate="">
                ...
                <img src="assets/img/shop/electronics/thumbs/10.png" width="110" alt="MacBook">
                        ...
                        <div class="w-100 min-w-0 ps-2 ps-sm-3">
                            <h5 class="d-flex animate-underline mb-2">
                                <a class="d-block fs-sm fw-medium text-truncate animate-target" href="shop-product-electronics.jsp">Apple iPhone 14 Plus 128GB Blue</a>
                            </h5>
                ...
                <div class="modal-body pb-3">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="review-name" value="${sessionScope.userDetails.firstName} ${sessionScope.userDetails.lastName}" readonly="">
            ...
            <div class="row pt-md-2 pt-lg-3 pb-sm-2 pb-md-3 pb-lg-4 pb-xl-5">
                ...
                <aside class="col-lg-3">
                    ...
                    My reviews
                            ...
                            <nav class="list-group list-group-borderless">
                                <a class="list-group-item list-group-item-action d-flex align-items-center" href="account-info.jsp">
                    ...
                    <option value="products">Products awaiting reviews</option>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Apple iPad 10.2" 2021 Wi-Fi 64 GB Space Gray (MK2K3RK/A)</a>
                            </div>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Laptop Apple MacBook Pro 13 M2</a>
                            </div>
                    ...
                    <i class="ci-chevron-right fs-lg"></i>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Razer Opus X Mercury Headphones (RZ04-03760200-R3M1)</a>
                            </div>
                            <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="d-md-none" style="width: 64px"></div>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#reviewForm">Leave a review</button>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">3D virtual reality glasses VR Shinecon G10 for smartphones with a large screen</a>
                            </div>
                            <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="d-md-none" style="width: 64px"></div>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#reviewForm">Leave a review</button>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Apple iPad Pro M2 2022 64 GB Space Gray</a>
                            </div>
                            <div class="d-flex h6 fs-sm pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="flex-shrink-0 d-md-none" style="width: 64px"></div>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Mobile phone Apple iPhone 14 256GB Starlight</a>
                            </div>
                            <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="d-md-none" style="width: 64px"></div>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#reviewForm">Leave a review</button>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Power Bank PBS 10000 mAh Black</a>
                            </div>
                            <div class="position-relative d-flex align-items-center text-decoration-none min-w-0 pt-1 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="flex-shrink-0 d-md-none" style="width: 64px"></div>
                                <div class="d-flex gap-1 fs-sm me-2 me-sm-3">
                    ...
                    <i class="ci-chevron-right fs-lg"></i>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">Apple iPhone 14 128GB Blue</a>
                            </div>
                            <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="d-md-none" style="width: 64px"></div>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#reviewForm">Leave a review</button>
                        ...
                        <div class="d-md-flex align-items-center justify-content-between gap-4 border-bottom py-3">
                            <div class="nav flex-nowrap position-relative align-items-center">
                                ...
                                <a class="nav-link stretched-link hover-effect-underline ps-3 p-0" href="shop-product-electronics.jsp">VRB01 Camera Nikon Max</a>
                            </div>
                            <div class="d-flex pt-2 pt-md-0 ps-3 ps-md-0 mb-2 mb-md-0">
                                <div class="d-md-none" style="width: 64px"></div>
                                <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#reviewForm">Leave a review</button>
