...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>BuyHive | Checkout v.1 - Shipping Address</title>
                ...
                <div class="accordion d-flex flex-column gap-5 pe-lg-4 pe-xl-0" id="checkout">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div class="w-100 ps-3 ps-md-4">
                            ...
                            <form class="needs-validation" novalidate="" method="POST" action="shipping">
                                <div class="row row-cols-1 row-cols-sm-2 g-3 g-sm-4 mb-4">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="shipping-fn" name="shipping-fn" value="${sessionScope.profile.firstName}" required="">
                                    </div>
                                    <div class="col">
                                        <label for="shipping-ln" class="form-label">Last name <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-lg" id="shipping-ln" name="shipping-ln" value="${sessionScope.profile.lastName}" required="">
                                    </div>
                                    <div class="col">
                                        <label for="shipping-email" class="form-label">Email address <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control form-control-lg" id="shipping-email" name="shipping-email" value="${sessionScope.email}" required="">
                                    </div>
                                    <div class="col">
                                        <label for="shipping-mobile" class="form-label">Mobile number</label>
                                        <input type="text" class="form-control form-control-lg" id="shipping-mobile" name="shipping-mobile" value="${sessionScope.profile.phone}">
                                    </div>
                                    <div class="col">
                                        <label for="shipping-city" class="form-label">City <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-lg" id="shipping-city" name="shipping-city" value="${primaryAddress.city}" required="">
                                    </div>
                                    <div class="col">
                                        <label for="shipping-postcode" class="form-label">Postcode <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-lg" id="shipping-postcode" name="shipping-postcode" value="${primaryAddress.zipCode}" required="">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    <label for="shipping-address" class="form-label">House / apartment number and street address <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control form-control-lg" id="shipping-address" name="shipping-address" value="${primaryAddress.street}" required="">
                                </div>
                                <div class="nav mb-4">
                        ...
                        <div class="p-sm-2 p-lg-0 p-xl-2">
                            <div class="border-bottom pb-4 mb-4">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div class="nav">
                                        <a class="nav-link text-decoration-underline p-0" href="checkout-v1-cart.jsp">Edit</a>
                                    </div>
                                </div>
                            ...
                            <ul class="list-unstyled fs-sm gap-3 mb-0">
                                <li class="d-flex justify-content-between">
                                    Subtotal (${fn:length(cartItems)} items):
                                    <span class="text-dark-emphasis fw-medium">$<fmt:formatNumber value="${totalPrice}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                                </li>
                                <li class="d-flex justify-content-between">
                                    Shipping:
                                    <span class="text-dark-emphasis fw-medium">$100.00</span>
                                </li>
                            </ul>
                            <div class="border-top pt-4 mt-4">
                                <div class="d-flex justify-content-between mb-3">
                                    <span class="fs-sm">Estimated total:</span>
                                    <span class="h5 mb-0">$<fmt:formatNumber value="${totalPrice + 100}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                                </div>
                            </div>
                        </div>
                    </div>
