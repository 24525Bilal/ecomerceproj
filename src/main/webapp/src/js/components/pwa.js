...
export default (() => {
    ...
    const installationPrompt = () => {
        ...
        // its just a pop showing download BuyHive app
        // you can customize it as per you needs
    //     const promptHTML = `
    ...
    //           <h5 class="pt-1" id="${promptId}Label">Install BuyHive app</h5>
    //           ${browser === 'Safari' ? `<p class="fs-sm mb-0">Add BuyHive to your home screen for quick and easy access to your shopping anytime, anywhere! Tap the <span class="fw-semibold">"Share"</span> icon in Safari and select <span class="fw-semibold">"Add to Home Screen"</span> from the options.</p>` : `<p class="fs-sm mb-0">Add BuyHive to your home screen for quick and easy access to your shopping anytime, anywhere!</p>`}
